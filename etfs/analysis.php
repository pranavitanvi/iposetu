    ...
    <div class="container">
        ...
        <div class="dashboard-header" id="quote-container">
            <div class="stock-info">
                ...
                <h1 id="quote-name">Loading ETF Data</h1>
            </div>
        ...
        <div class="chart-container">
            <div class="selector-controls">
                <select id="stock-selector">
                    <option value="NSE_EQ|INF204KB14I2">Nifty BeES (NIFTYBEES)</option>
                    <option value="NSE_EQ|INF204KB17I5">Gold BeES (GOLDBEES)</option>
                    <option value="NSE_EQ|INF204KB15I9">Bank BeES (BANKBEES)</option>
                    <option value="NSE_EQ|INF732E01037">Liquid BeES (LIQUIDBEES)</option>
                </select>
            </div>
...
<script src="<?= BASE_URL ?>assets/js/etf-chart.js?v=1"></script>
</body>
</html>
